    ...
    >
      <div className="container-wide flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <Button asChild variant="default" className="bg-secondary hover:bg-secondary hover:brightness-90 text-white hover:text-white transition-all duration-300">
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-background border-b border-border shadow-lg animate-fade-in">
          <nav className="container-wide py-6 flex flex-col gap-4">
            ...
            <Button asChild variant="default" className="mt-2 bg-secondary hover:bg-secondary hover:brightness-90 text-white hover:text-white transition-all duration-300">
