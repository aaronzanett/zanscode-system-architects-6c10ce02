...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    // Career Page
    'career.title': 'Bergabung dengan Zanscode',
    'career.subtitle': 'Bangun masa depan teknologi bersama tim yang passionate dan terus berkembang.',
    'career.why.title': 'Mengapa Bergabung?',
    'career.why.desc': 'Di Zanscode, Anda akan bekerja dengan teknologi terkini, proyek yang menantang, dan tim yang saling mendukung. Kami percaya pada pertumbuhan bersama dan memberikan dampak nyata.',
    'career.openings.title': 'Posisi Tersedia',
    'career.openings.subtitle': 'Temukan peran yang sesuai dengan keahlian dan passion Anda.',
    'career.fulltime': 'Full-time',
    'career.parttime': 'Part-time',
    'career.remote': 'Remote',
    'career.hybrid': 'Hybrid',
    'career.engineering': 'Engineering',
    'career.design': 'Design',
    'career.business': 'Business',
    'career.job1.title': 'Senior Full-Stack Developer',
    'career.job1.desc': 'Membangun sistem bisnis kustom dengan teknologi modern. Pengalaman React, Node.js, dan database diperlukan.',
    'career.job2.title': 'Backend Developer',
    'career.job2.desc': 'Mengembangkan API dan arsitektur backend yang skalabel untuk aplikasi enterprise.',
    'career.job3.title': 'UI/UX Designer',
    'career.job3.desc': 'Merancang pengalaman pengguna yang intuitif dan interface yang menarik untuk produk digital.',
    'career.job4.title': 'Business Development',
    'career.job4.desc': 'Mengidentifikasi peluang bisnis baru dan membangun hubungan dengan klien potensial.',
    'career.apply': 'Lamar Sekarang',
    'career.cta.title': 'Tidak Menemukan Posisi yang Cocok?',
    'career.cta.subtitle': 'Kami selalu mencari talenta berbakat. Kirimkan CV Anda dan ceritakan tentang keahlian Anda.',
    'career.cta.button': 'Hubungi Kami',
  ...
  en: {
    ...
    // Career Page
    'career.title': 'Join Zanscode',
    'career.subtitle': 'Build the future of technology with a passionate and growing team.',
    'career.why.title': 'Why Join Us?',
    'career.why.desc': 'At Zanscode, you\'ll work with cutting-edge technology, challenging projects, and a supportive team. We believe in growing together and making real impact.',
    'career.openings.title': 'Open Positions',
    'career.openings.subtitle': 'Find a role that matches your skills and passion.',
    'career.fulltime': 'Full-time',
    'career.parttime': 'Part-time',
    'career.remote': 'Remote',
    'career.hybrid': 'Hybrid',
    ...
    'career.business': 'Business',
    'career.job1.title': 'Senior Full-Stack Developer',
    'career.job1.desc': 'Build custom business systems with modern technology. Experience with React, Node.js, and databases required.',
    'career.job2.title': 'Backend Developer',
    'career.job2.desc': 'Develop scalable APIs and backend architecture for enterprise applications.',
    'career.job3.title': 'UI/UX Designer',
    'career.job3.desc': 'Design intuitive user experiences and attractive interfaces for digital products.',
    'career.job4.title': 'Business Development',
    'career.job4.desc': 'Identify new business opportunities and build relationships with potential clients.',
    'career.apply': 'Apply Now',
    'career.cta.title': 'Don\'t See the Right Position?',
    'career.cta.subtitle': 'We\'re always looking for talented individuals. Send us your CV and tell us about your skills.',
    'career.cta.button': 'Contact Us',
